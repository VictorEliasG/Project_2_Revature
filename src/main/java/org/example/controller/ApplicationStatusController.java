...
public class ApplicationStatusController {
    ...
    public ResponseEntity<ApplicationStatus> createApplicationStatus(@RequestBody ApplicationStatus applicationStatus) {
        ApplicationStatus createdApplicationStatus = applicationStatusService
                .createApplicationStatus(applicationStatus);
        return ResponseEntity.status(HttpStatus.CREATED).body(createdApplicationStatus);
    }

    @PutMapping("/{id}")
    public ResponseEntity<ApplicationStatus> updateApplicationStatus(@PathVariable Long id,
            @RequestBody ApplicationStatus applicationStatus) {
        Optional<ApplicationStatus> updatedApplicationStatus = applicationStatusService.updateApplicationStatus(id,
                applicationStatus);
